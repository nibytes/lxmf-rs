...
pub struct LinkEventData {
    ...
    pub event: LinkEvent,
    peer_identity_hash: Option<AddressHash>,
}

impl LinkEventData {
    pub fn new(id: LinkId, address_hash: AddressHash, event: LinkEvent) -> Self {
        Self {
            id,
            address_hash,
            event,
    ...
    pub fn peer_identity_hash(&self) -> Option<AddressHash> {
...
impl Link {
    ...
    fn post_event(&self, event: LinkEvent) {
        let _ = self.event_tx.send(LinkEventData {
            ...
            event,
            peer_identity_hash: Some(self.peer_identity.address_hash),
        });
    }
